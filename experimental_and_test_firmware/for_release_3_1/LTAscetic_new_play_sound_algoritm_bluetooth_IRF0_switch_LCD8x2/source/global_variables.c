...
volatile EEMEM TIR_CARRIER_FREQUENCY eeprom_ir_carr_freq;//использемая частота несущей ИК сигнала 
...
volatile EEMEM uint16_t sound_7_adress;//адрес в eeprom звука выстрела
volatile EEMEM uint16_t sound_7_size;//длина в байтах звука выстрела
volatile EEMEM uint16_t sound_8_adress;//адрес в eeprom звука выстрела
volatile EEMEM uint16_t sound_8_size;//длина в байтах звука выстрела
volatile EEMEM uint16_t sound_9_adress;//адрес в eeprom звука выстрела
...
volatile tir_message ir_message;//структура для хранения принятого по ИК сообщения
...
volatile tsound_to_play curr_sound; //звук, который воспроизводится в данный момент, или последний воспроизведенный звук 

volatile bool status_need_update; //исли true, то нужно обновить данные на ЖКИ

volatile uint8_t safe_counter; //счетчик времени спасения

volatile uint16_t cyclic_deley_counter; //обратный счетчик длительности между выстрелами при автоматической стрельбе

volatile EEMEM uint16_t eeprom_cyclic_rate;//скорострельность, переменная в eeprom

volatile EEMEM uint8_t eeprom_safe_duration; //время неуязвимости после ранения (в десятых длях секунды)