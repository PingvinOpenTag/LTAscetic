...
#define IR_LED_HIGH_POWER_PORT PORTA 
#define IR_LED_HIGH_POWER_DDR DDRA 

#define IR_LED_LOW_POWER_PORT PORTA 
#define IR_LED_LOW_POWER_DDR DDRA 


#define LIFE_LEDS_PORT PORTA
#define LIFE_LEDS_DDR DDRA
#define FIRE_LED_PORT PORTD
#define FIRE_LED_DDR DDRD
...
#define RELOAD_KEY_PORT PORTD //Порт, к которому подключен переключатель "DAMAGE" (урон)
#define RELOAD_KEY_DDR DDRD 
#define RELOAD_KEY_IN PIND
...
#define IR_LED_HIGH_POWER_PIN (1<<1)

#define IR_LED_LOW_POWER_PIN (1<<2)


#define FIRE_LED_PIN (1<<7)
#define BULLETS_OUT_LED_PIN (1<<0)
#define LIFE_LED1_PIN (1<<3)
#define LIFE_LED2_PIN (1<<4)
#define LIFE_LED3_PIN (1<<5)
#define LIFE_LED4_PIN (1<<6)
#define WOUND_LED_PIN (1<<5)
...
#define RELOAD_KEY_PIN (1<<6)
#define FIRE_MODE_KEY_PIN (1<<6)
