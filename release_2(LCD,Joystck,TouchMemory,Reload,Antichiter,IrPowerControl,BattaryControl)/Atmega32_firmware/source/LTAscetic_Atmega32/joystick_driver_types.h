#define UP_KEY_PORT PORTB //Порт, к которому подключен переключатель "DAMAGE" (урон)
...
#define RIGHT_KEY_PORT PORTB //Порт, к которому подключен переключатель "DAMAGE" (урон)
...
#define DOWN_KEY_PORT PORTB //Порт, к которому подключен переключатель "DAMAGE" (урон)
#define DOWN_KEY_DDR DDRB 
#define DOWN_KEY_IN PINB
#define DOWN_KEY_PIN (1<<1)
#define DOWN_KEY_MASK (1<<2)

#define LEFT_KEY_PORT PORTB //Порт, к которому подключен переключатель "DAMAGE" (урон)
