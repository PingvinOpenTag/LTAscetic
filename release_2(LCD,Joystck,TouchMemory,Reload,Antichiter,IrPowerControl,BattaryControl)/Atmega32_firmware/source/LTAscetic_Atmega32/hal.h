...
#define DEFAULT_BATT_FULL_VOLTAGE 5.5 //напряжение полностью заряженной батареи

#define DEFAULT_BATT_LOW_VOLTAGE 4.5 //напряжение полностью разряженной батареи
