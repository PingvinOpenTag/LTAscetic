...
#define DEFAULT_BATT_FULL_VOLTAGE 4000 //напр€жение полностью зар€женной батареи в милливольтах

#define DEFAULT_BATT_LOW_VOLTAGE 2700 //напр€жение полностью разр€женной батареи в милливольтах
