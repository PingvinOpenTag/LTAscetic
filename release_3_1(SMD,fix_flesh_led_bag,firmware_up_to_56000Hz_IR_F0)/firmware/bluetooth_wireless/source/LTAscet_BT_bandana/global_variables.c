...
volatile  uint16_t worn_led_on_timer; 
...
volatile bool receiver_on;//флаг, показывающий, что идет прием ИК пакета
volatile bool bt_connected;//флаг, показывающий, что соединение с по bluetooth установлено
